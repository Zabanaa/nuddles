...
<img src="https://travis-ci.org/Zabanaa/nuddles.svg?branch=master">
...
Nuddles also exposes three other classes: `Venue`, `Checkin` and  `List`. Use them to retrieve info
